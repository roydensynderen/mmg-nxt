  ...
  return (
    <section className="contact-form">
      <div className="contact-form__container">
        <div className="contact-form__image" style={{ 
          background: `url('/assets/doc.png')`, 
          backgroundRepeat: 'no-repeat', 
          backgroundSize: 'cover', 
          backgroundPosition: 'right' }}></div>

        <form className="contact-form__form" action="https://formspree.io/f/xwkwwrov" method="POST">
          <h2 className="contact-form__header">We'd love to hear from you</h2>
          <h3 className="contact-form__subheader">Send us a message and we'll respond as soon as possible</h3>
